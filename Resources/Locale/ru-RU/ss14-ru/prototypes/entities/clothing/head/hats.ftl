...
ent-ClothingHeadHatHunter = Шляпа Охотника на нечисть
    .desc = Прекрасная шляпа для борьбы с нечистой силой.
ent-ClothingHeadLeaderHatHunter = Шляпа командующего охотников на нечисть
    .desc = Прекрасная шляпа для борьбы с нечистой силой.
