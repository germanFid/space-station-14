...
station-goal-rnd-reserveenergy = РНД: Создать систему резервного питания отдела при помощи генераторов.
...
station-goal-med-stimulators = МЕД: Создать партию боевых стимуляторов и медикаментов для быстрой реанимации, после чего передать их в бриг.
...
station-goal-serv-theater = СЕРВИС: Поставить спектакль по короткой пьесе на своё усмотрение.

station-goal-serv-barman = СЕРВИС: Провести аттестацию бармена на знание коктейлей по системе ассоциации барменов (полученные в процессе коктейли пойдут на стол зрителям. А аттестировать должен ГП).

station-goal-serv-dinner = СЕРВИС: Провести званый ужин для всех желающих.

station-goal-serv-liturgy = СЕРВИС: Провести литургию в церкви для всех желающих.

station-goal-cmd-party = КМД: Подготовить вечеринку для всего экипажа в честь Иана.

station-goal-cargo-conveyor = КАРГО: Оборудовать отдел конвеером, ведущим от шаттла к ресепшену для быстрой подачи заказанных товаров посетителям.
