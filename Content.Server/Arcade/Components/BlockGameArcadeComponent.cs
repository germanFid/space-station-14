...
public sealed class BlockGameArcadeComponent : Component
{
    ...
    public BoundUserInterface? UserInterface => _userInterfaceSystem.GetUiOrNull(Owner, BlockGameUiKey.Key);
    ...
    private void UpdatePlayerStatus(IPlayerSession session)
    {
        if (UserInterface != null)
            _userInterfaceSystem.TrySendUiMessage(UserInterface, new BlockGameMessages.BlockGameUserStatusMessage(_player == session), session);
    }
    ...
    public void OnPowerStateChanged(PowerChangedEvent e)
    {
        if (e.Powered) return;
        if (UserInterface != null)
            _userInterfaceSystem.CloseAll(UserInterface);
        _player = null;
        _spectators.Clear();
    }
    ...
    private sealed class BlockGame
    {
        ...
        {
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameVisualUpdateMessage(_nextPiece.BlocksForPreview(), BlockGameMessages.BlockGameVisualType.NextBlock));
        }

        private void SendNextPieceUpdate(IPlayerSession session)
        {
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.TrySendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameVisualUpdateMessage(_nextPiece.BlocksForPreview(), BlockGameMessages.BlockGameVisualType.NextBlock), session);
        }
        ...
        private void SendHoldPieceUpdate()
        {
            if (_component.UserInterface != null)
            {
                if (_heldPiece.HasValue)
                    _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                        new BlockGameMessages.BlockGameVisualUpdateMessage(_heldPiece.Value.BlocksForPreview(),
                            BlockGameMessages.BlockGameVisualType.HoldBlock));
                else
                    _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                        new BlockGameMessages.BlockGameVisualUpdateMessage(Array.Empty<BlockGameBlock>(),
                            BlockGameMessages.BlockGameVisualType.HoldBlock));
            }
        }
        ...
        private void SendHoldPieceUpdate(IPlayerSession session)
        {
            ...
            {
                if (_heldPiece.HasValue)
                    _component._userInterfaceSystem.TrySendUiMessage(_component.UserInterface,
                        new BlockGameMessages.BlockGameVisualUpdateMessage(_heldPiece.Value.BlocksForPreview(),
                            BlockGameMessages.BlockGameVisualType.HoldBlock),
                        session);
                else
        ...
        {
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameScoreUpdateMessage(Points));
        }
        ...
        {
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameLevelUpdateMessage(Level));
        }
        ...
        {
            var entitySystem = _component._entityManager.System<ArcadeSystem>();
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameHighScoreUpdateMessage(entitySystem.GetLocalHighscores(), entitySystem.GetGlobalHighscores()));
        }
        ...
        private void SendHighscoreUpdate(IPlayerSession session)
        {
            var entitySystem = _component._entityManager.System<ArcadeSystem>();
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.TrySendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameHighScoreUpdateMessage(entitySystem.GetLocalHighscores(), entitySystem.GetGlobalHighscores()), session);
        }

        public void StartGame()
        {
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface, new BlockGameMessages.BlockGameSetScreenMessage(BlockGameMessages.BlockGameScreen.Game));
        ...
        private void InitializeNewBlock()
        {
            ...
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                    new BlockGameMessages.BlockGameVisualUpdateMessage(_nextPiece.BlocksForPreview(),
        ...
        public void ProcessInput(BlockGamePlayerAction action)
        {
            ...
            switch (action)
            {
                ...
                case BlockGamePlayerAction.Pause:
                    ...
                    if (_component.UserInterface != null)
                        _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                            new BlockGameMessages.BlockGameSetScreenMessage(BlockGameMessages.BlockGameScreen.Pause, _started));
                    break;
                ...
                case BlockGamePlayerAction.ShowHighscores:
                    ...
                    if (_component.UserInterface != null)
                        _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                            new BlockGameMessages.BlockGameSetScreenMessage(BlockGameMessages.BlockGameScreen.Highscores, _started));
                    break;
            }
        }
        ...
        public void UpdateAllFieldUI()
        {
            ...
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                    new BlockGameMessages.BlockGameVisualUpdateMessage(computedField.ToArray(), BlockGameMessages.BlockGameVisualType.GameField));
        }
        ...
        public void UpdateFieldUI(IPlayerSession session)
        {
            ...
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.TrySendUiMessage(_component.UserInterface,
                    new BlockGameMessages.BlockGameVisualUpdateMessage(computedField.ToArray(),
        ...
        private void InvokeGameover()
        {
            ...
            {
                var blockGameSystem = _component._entityManager.System<ArcadeSystem>();
            ...
            if (_component.UserInterface != null)
                _component._userInterfaceSystem.SendUiMessage(_component.UserInterface,
                    new BlockGameMessages.BlockGameGameOverScreenMessage(Points,
        ...
        public void UpdateNewPlayerUI(IPlayerSession session)
        {
            ...
            else
            {
                ...
                else
                {
                    if (_component.UserInterface != null)
                        _component._userInterfaceSystem.TrySendUiMessage(_component.UserInterface,
                            new BlockGameMessages.BlockGameSetScreenMessage(BlockGameMessages.BlockGameScreen.Game, Started), session);
                }
            }
