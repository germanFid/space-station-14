...
namespace Content.Server.Werewolf
{
    ...
    public sealed class WerewolfComponent : Component
    {
        ...
        public SoundSpecifier? SoundPupation = new SoundPathSpecifier("/Audio/FANA/Werewolf/pupateactsound.ogg");
        ...
        public SoundSpecifier? SoundPupaEat = new SoundPathSpecifier("/Audio/FANA/Werewolf/pupaeatsound.ogg");
